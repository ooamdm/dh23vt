...
import { firebaseConfigA, firebaseConfigB } from '@/services/firebase-configs.js';

// Import các hàm xác thực và cơ sở dữ liệu từ các file mới
import { signInForProject, signOutAll } from '@/apis/auth.js';
import { fetchDashboardData } from '@/services/firestore.js';
...
const stats = React.useMemo(() => {
    ...
    const showLoginPage = !activeUser && isAuthReady;
